        ...
        if (allanswer.length == 0) {
            ...
            getSingleAnswer(id).then((res) => {
                ...
                if (res.status) {
                    ...
                    setAnswer(res.results[questionindex].answer);
                            ...
                            <br></br>
                             ...
                             <div className="singleques col-lg-12 col-sm-6  col-12">
                                                ...
                                                {(current_type!='mcq')?(
                                                        ...
                                                        <Form.Control type="text" as="textarea" name='Answer' value={answer} onChange={(e) => setAnswerstud(e.target.value)} placeholder='Answers'  rows={5} ></Form.Control>
                                                        </div>
                                                                ):''}
